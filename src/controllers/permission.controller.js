...
export const permissionController = {
    ...
    findOne: async function (req, res, next) {
        try {
            ...
            const response = responseSuccess(
                result,
                `Get permission #${req.params.id} successfully`
            );
            res.status(response.code).json(response);
        } catch (err) {
            next(err);
    ...
    update: async function (req, res, next) {
        try {
            ...
            const response = responseSuccess(
                result,
                `Update permission #${req.params.id} successfully`
            );
            res.status(response.code).json(response);
        } catch (err) {
            next(err);
    ...
    remove: async function (req, res, next) {
        try {
            ...
            const response = responseSuccess(
                result,
                `Remove permission #${req.params.id} successfully`
            );
            res.status(response.code).json(response);
        } catch (err) {
            next(err);
